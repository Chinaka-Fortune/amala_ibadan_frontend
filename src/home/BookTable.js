...
import bookingImge from '../images/bookingService.jpg'
import './Home.css'
...
const BookTable = () => {
  ...
  return (
    <>
    <div className="container-fluid mt-5 px-0 fadeInUp " >
      <div className="row g-0 d-flex align-items-center">
        <div className="col-md-6 bg-danger ourImpactAnimate">
          
            <img src={bookingImge} className="img-fluid w-100 h-100" style={{objectFit:'cover'}} alt=""/>
        </div>
        <div className="col-md-6 bg-dark align-items-center">
          <div className="p-5">
            <h5 className=" text-start generalTextColor ourLandinAnimate2">
              Reservation
            </h5>
            ...
            <form action="">
              <div className="row g-3 ourImpactAnimate">
                ...
                <div className="col-12">
                  <button type="submit" className="generalBtnColor border-0  py-2 fw-bolder rounded w-100"
    ...
    <section className=" container-fluid ps-md-5 mt-5 mb-3 generalColor py-4">
    <div className="row ourImpactAnimate">
      <h4 className="fw-bolder text-muted mb-4">Subscribe to Our News Letter</h4>
      <div className="newsLetter d-flex align-items-center justify-content-cente gap-2">
        <input type="email" placeholder="Enter mail..." className=" rounded-left py-2 border-0 rounded-pill ps-3 pe-4 fw-bolder" value={newsLetter} onChange={handleNewsLetterChange}/>
        <input type="submit" value='submit' className="px-3 px-md-4 py-2 border-0 bg-warning rounded-pill fw-bolder" />
      </div>
    </div>
    </section>
    </> 
