...
const Contact = () => {
  ...
  return (
    <div className="container-fluid " >
      <div className="row d-flex justify-content-center align-items-center " style={{minHeight:100 + 'vmin'}}>
        <div className="col-sm-6">
          <img src={checfContactImg} alt="" className="img-fluid w-100  contactImage mb-md-3" style={{aspectRatio:6/5}} />
        </div>
        <div className="col-sm-6 mt-2 px-sm-5 mt-3 scaleAnime">
          ...
          <form action="" className="d-flex flex-column gap-4 my-2 ">
            ...
            <input
              type="submit"
              value="SEND"
              className="py-2 rounded-3 fw-bolder  generalBtnColor border-0"
            />
          </form>
        </div>
      </div>
